...
def parse_arguments():
    ...
    parser.add_argument("--port", type=int, default=os.environ.get('PROXY_PORT'), required=False, help="Port Number to Listen [default: 53]")
    parser.add_argument("--ca_path", type=str, default=os.environ.get('CA_CERT_PATH'), required=False, help="CA Cert File path [default: /etc/ssl/cert.pem]")
